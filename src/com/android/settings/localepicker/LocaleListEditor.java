...
public class LocaleListEditor extends RestrictedSettingsFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstState) {
        ...
        View contentScrollableContainer = result.findViewById(R.id.main_content_scrollable_container);
        if ( contentScrollableContainer != null )
         contentScrollableContainer.setVisibility(View.GONE);

...
public class ExUIVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "ExUIVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_EXUI_VERSION_PROP = "org.extendedui.version";
    private static final String KEY_EXUI_BUILDTYPE_PROP = "org.extendedui.build_type";
    ...
    public ExUIVersionDetailPreferenceController(Context context, String key) {
        super(context, key);

...
public class ShapeShiftVersionPreferenceController extends BasePreferenceController {

    private static final String TAG = "ssosVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_SSOS_VERSION_PROP = "ro.ssos.platform.version";
    ...
    public ShapeShiftVersionPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(),
                mContext.getText(R.string.ssos_version));
    }
}

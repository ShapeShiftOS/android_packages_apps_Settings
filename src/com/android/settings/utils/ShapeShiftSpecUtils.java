...
public class ShapeShiftSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String SHAPESHIFT_CPU_MODEL_PROPERTY = "ro.ssos.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelShapeShift = SystemProperties.get(SHAPESHIFT_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelShapeShift.isEmpty()) {
            return cpuModelShapeShift;

...
public class BatteryInfo {
    ...
    private static void updateBatteryInfoCharging(Context context, Intent batteryBroadcast,
        ...
        if (chargeTime > 0 && status != BatteryManager.BATTERY_STATUS_FULL) {
            ...
            if (dashChargeStatus) {
                info.chargeStatusLabel = resources.getString(R.string.battery_info_status_dash_charging);
            } else if (warpChargeStatus) {
                info.chargeStatusLabel = resources.getString(R.string.battery_info_status_warp_charging);
            } else {
                info.chargeStatusLabel = resources.getString(R.string.battery_info_status_charging);
            }
